...
processMetaInfoDt <- function(dt){
    dt[, `:=`(
        ...
        ,
        TOP_motif_length = tss_p1_pTOP + tss_p2_pTOP + tss_p3_pTOP,
...
all.uni.dev.cv.summary.dt %T>%
    ...
    scale_y_continuous(
        labels = scales::percent_format(accuracy = 1), limits = c(0, 0.3)
    ) +
    xlab("mRNA features") +
    ylab("R2") +
    theme(
...
![](s8-3-1-1-validation-of-method_single-condition-MRL-prediction-v3_files/figure-html/eval mRNA feature contribution-1.png)<!-- -->
...
![](s8-3-1-1-validation-of-method_single-condition-MRL-prediction-v3_files/figure-html/preliminary analysis-1.png)<!-- -->
...
![](s8-3-1-1-validation-of-method_single-condition-MRL-prediction-v3_files/figure-html/uAUG vs MRL-1.png)<!-- -->
...
![](s8-3-1-1-validation-of-method_single-condition-MRL-prediction-v3_files/figure-html/CDS length-1.png)<!-- -->
...
![](s8-3-1-1-validation-of-method_single-condition-MRL-prediction-v3_files/figure-html/RNA structure near cap-1.png)<!-- -->
...
![](s8-3-1-1-validation-of-method_single-condition-MRL-prediction-v3_files/figure-html/kozak score-1.png)<!-- -->
...
##  [1] corrplot_0.84     mgcv_1.8-31       nlme_3.1-148      knitr_1.28       
...
##  [9] generics_0.0.2              htmltools_0.4.0            
## [11] stats4_4.0.0                rtracklayer_1.48.0         
## [13] yaml_2.2.1                  XML_3.99-0.3               
## [15] rlang_0.4.10                pillar_1.4.4               
## [17] glue_1.4.1                  withr_2.4.1                
## [19] BiocParallel_1.22.0         BiocGenerics_0.34.0        
## [21] matrixStats_0.56.0          GenomeInfoDbData_1.2.3     
## [23] lifecycle_0.2.0             zlibbioc_1.34.0            
## [25] Biostrings_2.56.0           munsell_0.5.0              
## [27] gtable_0.3.0                ggsci_2.9                  
## [29] evaluate_0.14               labeling_0.3               
## [31] Biobase_2.48.0              IRanges_2.22.1             
## [33] GenomeInfoDb_1.24.0         Rcpp_1.0.4.6               
## [35] scales_1.1.1                DelayedArray_0.14.0        
## [37] S4Vectors_0.26.0            XVector_0.28.0             
## [39] farver_2.0.3                Rsamtools_2.4.0            
## [41] digest_0.6.25               stringi_1.4.6              
## [43] GenomicRanges_1.40.0        grid_4.0.0                 
## [45] tools_4.0.0                 bitops_1.0-6               
## [47] RCurl_1.98-1.2              tibble_3.0.1               
## [49] crayon_1.3.4                pkgconfig_2.0.3            
## [51] ellipsis_0.3.1              Matrix_1.2-18              
