---
title: "s4-1-1 Definition of TSS"
...
1. Pooling of the 5' end-Seq of total mRNA data from the following samples: generate pooled bedgraph file
...
[dpi](https://github.com/hkawaji/dpi1) will be used to define TSS clusters.
In order to robustly identify TSS clusters, the TSS from 5' end-Seq data and CAGE data (from FANTOM project) will be used as the input.

First, TSS data (from both 5' end-Seq and FANTOM CAGE) overlapping with paraclu identified cluster areas will be selected.
...
Note that genes in chrM won't be filtered by G ratio as mitchodrial mRNAs does not have a conventional cap.
...
![](s4-1-1-tss-definition_v3_files/figure-html/filter with untemplated G ratio-1.png)<!-- -->
...
![](s4-1-1-tss-definition_v3_files/figure-html/annotate TSS-1.png)<!-- -->
...
Since mitchodrial mRNA does not have a typical 5' cap, the TSS were filtered by the annotation
...
![](s4-1-1-tss-definition_v3_files/figure-html/resplit filtered tss-1.png)<!-- -->
...
![](s4-1-1-tss-definition_v3_files/figure-html/resplit filtered tss-2.png)<!-- -->
...
Cluster width information will be extracted here.
The following ranges will be also extracted.
...
![](s4-1-1-tss-definition_v3_files/figure-html/cluster width calculation-1.png)<!-- -->
