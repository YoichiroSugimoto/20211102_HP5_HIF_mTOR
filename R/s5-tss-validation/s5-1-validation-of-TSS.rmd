...
source.cols <- c("Position", "Proportion")
setnames(fig.1c.sdt, old = c("x", "y"), new = source.cols)
fig.1c.sdt[, Proportion := Proportion*100]

fwrite(
    fig.1c.sdt[, source.cols, with = FALSE],
    file = file.path(source.data.by.panel.dir, "Fig.1c.csv")
)
