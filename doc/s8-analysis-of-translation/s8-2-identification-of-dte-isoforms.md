...
## [1] "Analyzing RCC4_VHL_EIF4E2_NA_[[:digit:]]_(NA|Torin1)"
## [1] "With the full model formula of ~sample + exon + fraction:exon + treatment:exon + fraction:treatment:exon"
## [1] "With the reduced model formula of ~sample + exon + fraction:exon + treatment:exon"
```
...
## [1] "Analyzing RCC4_noVHL_EIF4E2_NA_[[:digit:]]_(NA|Torin1)"
## [1] "With the full model formula of ~sample + exon + fraction:exon + treatment:exon + fraction:treatment:exon"
## [1] "With the reduced model formula of ~sample + exon + fraction:exon + treatment:exon"
```
