...
```{r ercc count and each fraction}
...
```{r calculate normalization factor based on ERCC}
...
```{r ERCC total vs DESeq2 size factors}
...
```{r export predicted size factors}
...
```{r calculate normalization factor based on ERCC with ribo 0}
...
```{r ERCC total vs DESeq2 size factors with ribo 0}
...
```{r export predicted size factors with ribo 0}
