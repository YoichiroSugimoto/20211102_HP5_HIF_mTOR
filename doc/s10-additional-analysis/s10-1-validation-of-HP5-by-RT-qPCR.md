...
```
    ...
    ## 1:        DEK  dist    27.47227         -3.598420  0.8962682
    ## 2:        DEK proxy    28.52501         -3.597852  0.8964597
    ## 3:      EIF5A  dist    25.16280         -3.518094  0.9241762
    ## 4:      EIF5A proxy    29.82663         -3.418213  0.9613293
    ## 5:      RBCK1  both    30.58086         -3.399781  0.9685053
    ## 6:      RBCK1  dist    29.69608         -3.418198  0.9613352
    ## 7:      TPGS2  both    28.47028         -3.439025  0.9533500
    ## 8:      TPGS2  dist    29.09549         -3.453525  0.9478666
...
```
    ...
    ##          gene  type       rsq
    ## 1:        DEK  dist 0.9998573
    ## 2:        DEK proxy 0.9990893
    ## 3:      EIF5A  dist 0.9996073
    ## 4:      EIF5A proxy 0.9997558
    ## 5:      RBCK1  both 0.9956700
    ## 6:      RBCK1  dist 0.9916796
    ## 7:      TPGS2  both 0.9998838
    ## 8:      TPGS2  dist 0.9992406
