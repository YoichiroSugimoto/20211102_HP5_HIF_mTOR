...
Rscript ../run_rmd.R s9-1-4-transcriptional-and-translational-regulation_intersection-of-VHL-and-mTOR.rmd

Rscript ../run_rmd.R s9-2-1-alt-TSS-and-HIF.rmd
Rscript ../run_rmd.R s9-2-2-alt-TSS-translation-v2.rmd
