...
```{r pool all sample group tss data}
...
```{r preparation of FANTOM cage data}
...
```{r filter with untemplated G ratio, fig.width = 7, fig.height = 5}
...
```{r filtering by expression level}
...
```{r filtering by expression level threshold}
...
```{r export useful data and functions}
