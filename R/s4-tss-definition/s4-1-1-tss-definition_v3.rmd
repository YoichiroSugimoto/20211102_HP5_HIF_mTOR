...
```{r pool_all_sample_group_tss_data}
...
```{r preparation_of_FANTOM_cage_data}
...
```{r filter_with_untemplated_G_ratio, fig.width = 7, fig.height = 5}
...
```{r filtering_by_expression_level}
...
```{r filtering_by_expression_level_threshold}
...
```{r export_useful_data_and_functions}
